<nav class="navbar navbar-expand-lg main-navbar sticky">
    ...
    <ul class="navbar-nav navbar-right">
        ...
        <li class="dropdown"><a href="#" data-bs-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
                <img alt="image" src="{{asset('adminAsset')}}/assets/img/user.png" class="user-img-radious-style">
            ...
            <div class="dropdown-menu dropdown-menu-right pullDown">
                ...
                <a href="#" class="dropdown-item has-icon text-danger" onclick="event.preventDefault();document.getElementById('LogOutForm').submit();"><i
