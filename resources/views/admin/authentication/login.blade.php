...
<!-- Mirrored from www.einfosoft.com/templates/admin/otika/source/light/auth-login.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 18 Jan 2023 08:52:53 GMT -->
<head>
    <meta charset="UTF-8">
                ...
                <div class="col-md-8 col-lg-6 col-xl-5">
                    <div class="card card-primary">
                        <div class="card-header align-items-center justify-content-center">
                            <h4 style="font-family:'Droid Sans Mono Slashed';font-size: 25px">Admin Login</h4>
                        </div>
                        <div class="card-body">
